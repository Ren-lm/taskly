...
// import { View, Text, FlatList, TouchableOpacity, StyleSheet, Alert, Modal, TextInput, TouchableWithoutFeedback } from 'react-native';
...
//       Alert.alert('Error', `Could not delete task. Please try again later. ${error.message}`);
//     }
//   };
...
//                         />
//                         <TouchableOpacity onPress={handleCustomTimeSet}>
//                           <Text style={styles.customTimeSetButton}>Set</Text>
//                         </TouchableOpacity>
//                       </View>
//                     )}
//                   </View>
...
//------- file attachment icon display fix
// import React, { useState, useEffect } from 'react';
// import { View, Text, FlatList, TouchableOpacity, StyleSheet, Alert, Modal, TextInput, TouchableWithoutFeedback } from 'react-native';
// import { AntDesign, MaterialIcons } from '@expo/vector-icons';
// import { GestureHandlerRootView, Swipeable } from 'react-native-gesture-handler';
...
//           renderItem={({ item }) => (
//             <Swipeable renderRightActions={() => renderRightActions(item._id)}>
//               <TouchableOpacity onPress={() => navigation.navigate('TaskDetails', { task: item, listId })}>
//                 <View style={styles.taskContainer}>
//                   <TouchableOpacity onPress={() => toggleCompleteTask(item._id)}>
//                     <MaterialIcons name={item.completed ? "check-circle" : "radio-button-unchecked"} size={24} color={item.completed ? "#22A39F" : "#222831"} />
//                   </TouchableOpacity>
...
//         <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate('TaskDetails', { task: null, listId })}>
//           <AntDesign name="pluscircle" size={50} color="#22A39F" />
//         </TouchableOpacity>
